          ...
          <div className="space-y-4">
            ...
            <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-4">
              <div className="flex items-start">
                ...
                <div className="ml-3 flex-1">
                  <h3 className="text-neutral-200 font-medium">Welcome to AlgoBoard!</h3>
            ...
            <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-4">
              <div className="flex items-start">
                ...
                <div className="ml-3 flex-1">
                  <h3 className="text-neutral-200 font-medium">New Feature: Rating Tracking</h3>
                  <p className="text-neutral-300 text-sm mt-1">
                    We've added automatic rating synchronization for Codeforces, AtCoder, Leetcode, and CodeChef platforms.
                  </p>
                  <p className="text-neutral-400 text-xs mt-2">August 12, 2025</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-4">
              <div className="flex items-start">
                ...
                <div className="ml-3 flex-1">
                  <h3 className="text-neutral-200 font-medium">Scheduled Maintenance</h3>
                  <p className="text-neutral-300 text-sm mt-1">
                    System is under maintenance.
                  </p>
                  <p className="text-neutral-400 text-xs mt-2">{new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  />
                  <div>
                    <h3 className="text-neutral-200 font-medium">Codeforces Round #912 (Div. 2)</h3>
                    <p className="text-neutral-400 text-sm">August 15, 2025 • 17:35 UTC</p>
                  </div>
                </div>
                <div className="text-right">
                  <span className="text-blue-400 text-sm font-medium">In 3 days</span>
            ...
            <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  />
                  <div>
                    <h3 className="text-neutral-200 font-medium">AtCoder Beginner Contest 364</h3>
                    <p className="text-neutral-400 text-sm">August 17, 2025 • 21:00 JST</p>
                  </div>
                </div>
                <div className="text-right">
                  <span className="text-green-400 text-sm font-medium">In 5 days</span>
            ...
            <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  />
                  <div>
                    <h3 className="text-neutral-200 font-medium">CodeChef Starters 147</h3>
                    <p className="text-neutral-400 text-sm">August 14, 2025 • 20:00 IST</p>
                  </div>
                </div>
                <div className="text-right">
                  <span className="text-yellow-400 text-sm font-medium">In 2 days</span>
            ...
            <div className="bg-neutral-800 border border-neutral-700 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  />
                  <div>
                    <h3 className="text-neutral-200 font-medium">Weekly Contest 408</h3>
                    <p className="text-neutral-400 text-sm">August 18, 2025 • 10:30 UTC</p>
                  </div>
                </div>
                <div className="text-right">
                  <span className="text-purple-400 text-sm font-medium">In 6 days</span>
