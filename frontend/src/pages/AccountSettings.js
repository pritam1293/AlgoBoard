...
const AccountSettings = () => {
  const { user, logout, updateProfile, validateProfileForm, profileLoading, profileMessage, clearProfileMessage } = useAuth();
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="md:col-span-2">
          <label className="flex items-center">
            ...
            <span className="text-sm font-medium text-neutral-300">I am a student</span>
          </label>
        </div>
      </div>
      {isEditing ? (
